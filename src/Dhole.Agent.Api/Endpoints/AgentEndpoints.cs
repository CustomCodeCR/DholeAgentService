...
public static class AgentEndpoints
{
    public static IEndpointRouteBuilder MapAgentEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        executions.MapGet("/{id:guid}/result",async(Guid id,IQueryDispatcher d,HttpContext h,CancellationToken ct)=>EndpointResults.FromResult(await d.DispatchAsync(new GetAgentExecutionResultQuery(id),ct),h)).RequireScope(AgentScopeNames.ExecutionsView);
