...
public static class AgentEndpoints
{
    public static IEndpointRouteBuilder MapAgentEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        executions.MapGet("/{id:guid}/tasks",async(Guid id,IQueryDispatcher d,CancellationToken ct)=>Results.Ok(ApiResponse<IReadOnlyCollection<AgentExecutionTaskDto>>.Ok(await d.DispatchAsync(new GetExecutionTasksQuery(id),ct)))).RequireScope(AgentScopeNames.ExecutionsView);
